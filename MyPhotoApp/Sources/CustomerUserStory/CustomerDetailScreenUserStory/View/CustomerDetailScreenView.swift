...
private class MockViewModel: CustomerDetailScreenViewModelType, ObservableObject {
    @Published var items: AuthorPortfolioModel = AuthorPortfolioModel(portfolio:
            DBPortfolioModel(id: UUID().uuidString,
                           author: DBAuthor(author: AuthorModel(id: UUID().uuidString,
                                                              rateAuthor: 4.32,
                                                              likedAuthor: true,
                                                              nameAuthor: "Iryna Test",
                                                              countryCode: "th",
                                                              city: "Phuket",
                           ...
                           reviews: [DBReviews(review: ReviewsModel(reviewerAuthor: "Safron Sandeev",
                                                                  reviewDescription: "Best photographer on the world",
                                                                  reviewRate: 5.0))],
                           appointmen: [
                            DBAppointmen(appointmen: AppointmenModel(data: Date(), timeSlot: [
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "08:00", available: false)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "09:00", available: true)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "10:00", available: false)),
                                ...
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "14:00", available: false)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "15:00", available: false)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "16:00", available: true)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "17:00", available: false)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "18:00", available: true)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "19:00", available: false)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "20:00", available: true)),
                            ])),
                            DBAppointmen(appointmen: AppointmenModel(data: Date(), timeSlot: [
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "10:00", available: false)),
                                DBTimeSlot(timeSlot: TimeSlotModel(time: "11:00", available: true)),
